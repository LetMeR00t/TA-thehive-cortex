...
import input_module_backfill_alerts_cases as input_module
...
"""
    ...
    Add your modular input logic to file input_module_backfill_alerts_cases.py
"""


class ModInputbackfill_alerts_cases(splunktaucclib.modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputbackfill_alerts_cases, self).__init__(
            "ta_thehive_cortex", "backfill_alerts_cases", use_single_instance
        )
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputbackfill_alerts_cases, self).get_scheme()
...
if __name__ == "__main__":
    exitcode = ModInputbackfill_alerts_cases().run(sys.argv)
    sys.exit(exitcode)
