...
class ModInputthehive_alerts_cases(splunktaucclib.modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputthehive_alerts_cases, self).__init__(
            "ta_thehive_cortex", "thehive_alerts_cases", use_single_instance
        )
