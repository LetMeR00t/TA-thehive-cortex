...
import input_module_backfill_audit as input_module
...
"""
    ...
    Add your modular input logic to file input_module_backfill_audit.py
"""


class ModInputbackfill_audit(splunktaucclib.modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputbackfill_audit, self).__init__(
            "ta_thehive_cortex", "backfill_audit", use_single_instance
        )
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputbackfill_audit, self).get_scheme()
        scheme.title = "TheHive: Audit logs"
...
if __name__ == "__main__":
    exitcode = ModInputbackfill_audit().run(sys.argv)
    sys.exit(exitcode)
