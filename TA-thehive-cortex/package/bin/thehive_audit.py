...
import input_module_thehive_audit as input_module
...
"""
    ...
    Add your modular input logic to file input_module_thehive_audit.py
"""


class ModInputthehive_audit(splunktaucclib.modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputthehive_audit, self).__init__(
            "ta_thehive_cortex", "thehive_audit", use_single_instance
        )
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputthehive_audit, self).get_scheme()
...
if __name__ == "__main__":
    exitcode = ModInputthehive_audit().run(sys.argv)
    sys.exit(exitcode)
