...
import input_module_thehive_observables as input_module
...
'''
    ...
    Add your modular input logic to file input_module_thehive_observables.py
'''
class ModInputthehive_observables(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputthehive_observables, self).__init__("ta_thehive_cortex", "thehive_observables", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputthehive_observables, self).get_scheme()
...
if __name__ == "__main__":
    exitcode = ModInputthehive_observables().run(sys.argv)
    sys.exit(exitcode)
