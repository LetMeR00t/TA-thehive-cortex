    ...
    def __init__(self, url = None, username = None, password = None, apiKey = None, proxies={}, cert = None , verify = True, organisation = None, version = None, sid = None, logger = None):
        ...
        try :
            ...
            if "CERTIFICATE_VERIFY_FAILED" in str(e):
                ...
                self.logger.error("[TH110-GENERIC-ERROR] THEHIVE_CONNECTION_ERROR - Error: "+str(e)+". If the error is persisting after several tries, please raise an issue to the application maintainer.")
                sys.exit(60)
