...
from splunktaucclib.rest_handler.eai import EAI_FIELDS
...
class CortexConfigurationHandler(admin.MConfigHandler):
    ...
    handledActions = [admin.ACTION_LIST, admin.ACTION_CREATE, admin.ACTION_EDIT, admin.ACTION_REMOVE, ACTION_CRED]
