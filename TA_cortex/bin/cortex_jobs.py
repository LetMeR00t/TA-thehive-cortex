...
if __name__ == '__main__':
    ...
    spl = client.connect(app="TA_cortex",owner="nobody",token=settings["sessionKey"])
    ...
    for job in jobs:
         ...
         event = {"id": job.id,"data": "["+job.dataType.upper()+"] "+job.data ,"analyzer": job.analyzerName ,"createdAt": job.createdAt/1000 ,"createdBy": job.createdBy+"/"+job.organization,"tlp": job.tlp ,"status": job.status ,"summary": summaries}
